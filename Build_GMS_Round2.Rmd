...
Check if there are any 'bad' stations (either test stations from RWS or stations which have been moved) in the dataframe.

REMOVE THESE STATIONS IN THE SELECT_DAYS SCRIPT!
