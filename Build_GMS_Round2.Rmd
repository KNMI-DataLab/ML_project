...
InSub <- createDataPartition(The_Days$TEMP, p = 0.10, list = FALSE)
...
save(Train_data, file = "/usr/people/kleingel/Projects/MLProject/Train_data_R2_SMALL.Rda")

# Save test
#save(Test_data, file = "F:/KNMI/Test_data_R2_BIG.Rda")
#save(Test_data, file = "/run/media/kleingel/Lexar/KNMI/Test_data_R2.Rda")
save(Test_data, file = "/usr/people/kleingel/Projects/MLProject/Test_data_R2_SMALL.Rda")
