...
Day_68 <- subset(The_Days,The_Days$DOY_Days == 68)
...
InSub <- createDataPartition(The_Days$TEMP, p = 0.20, list = FALSE)
...
save(Train_data, file = "/usr/people/kleingel/Projects/MLProject/Train_data_R2_SMALL2.Rda")

# Save test
#save(Test_data, file = "F:/KNMI/Test_data_R2_BIG.Rda")
#save(Test_data, file = "/run/media/kleingel/Lexar/KNMI/Test_data_R2.Rda")
save(Test_data, file = "/usr/people/kleingel/Projects/MLProject/Test_data_R2_SMALL2.Rda")
