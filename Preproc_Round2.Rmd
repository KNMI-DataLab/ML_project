...
png(filename = "/usr/people/kleingel/Projects/MLProject/Corrplot_Train_BIG_noPCA")
corrplot(corTrain_1, method = "circle")
dev.off()

# Correlation plot for the test set
corTest_1 <- cor(Test_set, use = "complete.obs")
png(filename = "/usr/people/kleingel/Projects/MLProject/Corrplot_Test_BIG_noPCA")
...
save(Train_set, file = "Train_BIG_noPCA.Rda")
save(Test_set, file = "Test_BIG_noPCA.Rda")
