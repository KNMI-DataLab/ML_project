...
Train_set <- load_obj("/usr/people/kleingel/Projects/MLProject/Train_data_R2_SMALL.Rda")

# Read in the test set
#Test_set <- load_obj("F:/KNMI/Test_data_R2_BIG.Rda")
#Test_set <- load_obj("/run/media/kleingel/Lexar/KNMI/Test_data_R2.Rda")
Test_set <- load_obj("/usr/people/kleingel/Projects/MLProject/Test_data_R2_SMALL.Rda")
...
Plot_Scree(Train_set, "_SMALL, train")

# Make a scree plot of the test set PC's 
Plot_Scree(Test_set, "_SMALL, test")
...
save(Train_set, file = "Train_SMALL.Rda")
save(Test_set, file = "Test_SMALL.Rda")
