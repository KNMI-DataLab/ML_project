...
Plot_Scree(Train_set, "_BIG, train")

# Make a scree plot of the test set PC's 
Plot_Scree(Test_set, "_BIG, test")
...
save(Train_set, file = "F:/KNMI/Train_BIG_noM.Rda")
save(Test_set, file = "F:/KNMI/Test_BIG-noM.Rda")

# Save the corresponding target variables
save(Target_Train, file = "F:/KNMI/Train_Target_BIG_noM.Rda")
save(Target_Test, file = "F:/KNMI/Test_Target_BIG_noM.Rda")
