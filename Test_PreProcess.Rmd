...
PCA_transformed_hist <- list()
PCA_transformed_point <- list()

for (i in seq_along(Cont_vars)){
    print(i)
    PCA_transformed_hist[[i]] <- ggplot(data.frame(x=Predictors_PCA[ , i]), aes(x))+ geom_histogram()+ ylab(Cont_vars[i])
    print(PCA_transformed_hist[[i]])
    
    PCA_transformed_point[[i]] <- ggplot(data.frame(x= seq_along(Predictors_PCA[ , i]), y = Predictors_PCA[ ,i]), aes(x, y)) + geom_point()+ ylab(Cont_vars[i])
    print(PCA_transformed_point[[i]])
...
Plot_histograms <- function(The_Data){
  ...
  for (i in seq_along(Cont_vars)){
    List_hist[[i]] <- ggplot(data.frame(x=The_Data[ , i]), aes(x))+ geom_histogram()+ ylab(Cont_vars[i])
  }
    return(List_hist)
}
...
Plot_Points <- function(The_Data){
  ...
  for (i in seq_along(Cont_vars)){
    List_point[[i]] <- ggplot(data.frame(x=seq_along(The_Data[ , i]), y = The_Data[ , i]), aes(x, y))+ geom_point()+ ylab(Cont_vars[i])
  }
    return(List_point)
}
...
Testt <- Plot_Points(Predictors_PCA)
